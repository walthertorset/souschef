...
9. Formatering i Chat: Når du svarer i chatten, MÅ du bruke standard Markdown-lister (bindestrek '- ') for alle ingredienser. Hver ingrediens SKAL stå på sin egen linje. Du SKAL bruke doble linjeskift (\\n\\n) mellom alle overskrifter, lister og avsnitt for å skape mest mulig luft på mobilskjermen. ALDRI skriv flere ting på samme linje (f.eks. skal Cuisine og Kategori stå på hver sin linje med luft mellom). Bruk alltid fet skrift for overskrifter.`,
        tools: tools,
      },
      history: history
    });

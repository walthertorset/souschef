...
9. Formatering i Chat: Når du foreslår en oppskrift, skal navnet på retten alltid stå i fet skrift (f.eks. **Kylling Tikka Masala**). Du MÅ bruke standard Markdown-lister (bindestrek '- ') for alle ingredienser. Hvis en oppskrift har deler (f.eks. en saus), skal du bruke en fet underoverskrift (f.eks. **Saus:**) rett over listen. Bruk bare ett enkelt linjeskift (\\n) mellom en underoverskrift og listen som følger den, men bruk doble linjeskift (\\n\\n) mellom hovedbolker som Ingredienser og Fremgangsmåte for å skape luft.`,
        tools: tools,
      },
      history: history
    });

...
9. Formatering i Chat: Når du svarer i chatten, MÅ du bruke standard Markdown-lister (bindestrek '- ') for alle ingredienser. Hvis en oppskrift har flere deler (f.eks. en marinade og en saus), skal du bruke underoverskrifter (f.eks. **Marinade:**) istedenfor å skrive det i parentes på hver linje. Bruk doble linjeskift (\\n\\n) mellom alle overskrifter og avsnitt for maksimal luft.`,
        tools: tools,
      },
      history: history
    });
